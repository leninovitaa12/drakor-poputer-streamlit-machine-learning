...
# Machine Learning Page
    ...
    features = st.multiselect("Pilih Fitur", ["Rank", "Popularity", "Score", "Episodes", "Duration", "Watchers"], default=["Score"]) 
    target = st.selectbox("Pilih Target", ["Rank", "Popularity", "Score"], index=2) # Index 2 corresponds to "Score"

    # Impute missing values for selected features ONLY
